...
`;async function k(){let{positionals:t,tokens:e,values:s}=_({allowPositionals:!0,strict:!1,tokens:!0,options:{help:{short:"h",type:"boolean",default:!1},version:{short:"v",type:"boolean",default:!1}}});if(s.version)return console.log(h.version);if(!t.length||s.help&&!t.length)return console.log(f.trim());let{index:o}=e.find(({kind:u})=>u=="positional"),r=x.slice(o+3),[i]=t;switch(i){case"copy":await c(r);break;case"libpath":m(r);break;default:console.log(f.trim())}}k().catch(t=>{console.error(t instanceof Error?t.message:t),process.exitCode=1});export{k as main};
